defmodule RailswitchBackend.AccountsGenerator do
  @moduledoc """
  `Ash.Generator`-based test data builders for the `RailswitchBackend.Accounts`
  domain.
  """
  ...
  def user(opts \\ []) do
    ...
    changeset_generator(
      RailswitchBackend.Accounts.User,
