defmodule RailswitchBackendWeb.OpenApi do
  @moduledoc false
  ...
  defp tenant_aware_types do
    for domain <- Application.get_env(:railswitch_backend, :ash_domains, []),
  ...
  defp app_version do
    :railswitch_backend |> Application.spec(:vsn) |> to_string()
  end
end
