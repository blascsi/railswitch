defmodule ConveyorBackendWeb.AuthFlowTest do
  @moduledoc """
  ...
  @remember_cookie "conveyor_remember_me"
  ...
  describe "POST /users/sign-in" do
    ...
    test "rejects an invalid password", %{conn: conn} do
      ...
      # A generic 401 (see lib/conveyor_backend_web/ash_json_api_errors.ex) that
